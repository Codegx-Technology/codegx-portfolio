    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10">
              Astella AI is more than a technology company. We're a team of innovators committed to 
              creating solutions that make a meaningful difference in Africa and beyond.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <h2 className="text-3xl font-bold font-inter mb-6">Our Mission</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              ...
              >
                <div className="bg-background rounded-lg p-6 shadow-md border border-border h-full">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold font-inter mb-4">Founder's Vision</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div className="relative rounded-lg overflow-hidden mb-6">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      <h3 className="text-2xl font-bold">Peter O. Oluoch</h3>
                      <p className="text-white/80">Founder & CEO, Astella AI</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-3">
              ...
              >
                <h3 className="text-xl font-bold mb-4">The Vision Forward</h3>
