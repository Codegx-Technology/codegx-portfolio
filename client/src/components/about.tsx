      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="md:flex md:items-center md:space-x-12">
          ...
          >
            ...
            <p className="text-lg mb-6">
              Currently leading a smart city infrastructure project using digital twins, urban planning systems, and IoT architecture. We aim to help organizations reduce operational costs by as much as 35% through maintainable systems that improve planning and delivery.
            </p>
